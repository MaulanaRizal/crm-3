            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Tambah Data Produk</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="card card-body col-9">
                        ...
                        <form action="<?= base_url('produk/insert') ?>" method="post">
                            <div class="form-group row">
                                ...
                                <input id=nama_produk type="text" class="form-control col-6" name='nama_produk' required>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input id=awal_penggunaan type="date" class="form-control col-3" name='awal_penggunaan'>;&nbsp;
                            ...
                            <div class="form-group row">
                                ...
                                <input id=akhir_penggunaan type="date" class="form-control col-3" name='akhir_penggunaan'>;&nbsp;
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" class="form-control col-6 money" id="inputNominalProduk" name='harga_produk' required>
                            </div>
                            <div class="form-group row">
