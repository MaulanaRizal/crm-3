                            ...
                            <form action="<?= base_url('pengguna/insert') ?> " method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <small style="color: red;" id=inputEmail class="alert-input">Input Email tidak boleh kosong</small>
                                ...
                                <div class="form-group m-b-0">
                                    <div class="offset-sm-3 col-sm-7">
                                        <button type="submit" class="btn btn-info waves-effect waves-light m-t-10" id='submitForm'>Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
